        ...
        *,
        ...
        model: Union[
            ...
            Literal[
                ...
                "openai/gpt-oss-120b",
                "openai/gpt-oss-20b",
                "llama-3.1-8b-instant/llama-3.1-8b-instant3-32b",
                "llama-3.1-8b-instant/llama-3.1-8b-instant3.6-27b",
                "llama-3.1-8b-instant/llama-3.1-8b-instant3.8-27b",
            ],
        ],
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          reasoning_effort: llama-3.1-8b-instant3 models support `none` to disable reasoning and `default` or null
              to use the model default.

              llama-3.1-8b-instant/llama-3.1-8b-instant3.8-27b additionally supports `low`, `medium`, and `high`. Its default
